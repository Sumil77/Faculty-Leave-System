    ...
    <div className="relative bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 w-[450px] p-8 rounded-3xl shadow-xl flex flex-row items-center space-x-6 hover:scale-105 transition-transform duration-300 ease-in-out mx-auto mb-10">
      ...
      <div className="flex flex-col space-y-4 w-3/4">
        ...
        <p className="text-md text-white">
          <strong className="font-semibold">Designation:</strong> {faculty.designation}
        </p>
        <p className="text-md text-white">
          <strong className="font-semibold">Department:</strong> {faculty.department}
        </p>
        ...
        <div className="flex items-center text-white">
          ...
          <p className="text-md">{faculty.phone}</p>
        </div>
        <p className="text-md text-white">
          <strong className="font-semibold">Date of Joining:</strong> {faculty.dateOfJoining}
        </p>
      </div>
