...
VALUES
-- Within last 1 month
('123', NOW() - INTERVAL '2 days', NOW() - INTERVAL '1 day', NOW(), 'casual', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '7 days', NOW() - INTERVAL '6 days', NOW() - INTERVAL '4 days', 'medical', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '11 days', NOW() - INTERVAL '10 days', NOW() - INTERVAL '8 days', 'casual', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '13 days', NOW() - INTERVAL '12 days', NOW() - INTERVAL '11 days', 'casual', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '16 days', NOW() - INTERVAL '15 days', NOW() - INTERVAL '13 days', 'specialCasual', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '18 days', NOW() - INTERVAL '17 days', NOW() - INTERVAL '15 days', 'casual', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '21 days', NOW() - INTERVAL '20 days', NOW() - INTERVAL '19 days', 'casual', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '23 days', NOW() - INTERVAL '22 days', NOW() - INTERVAL '21 days', 'medical', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '27 days', NOW() - INTERVAL '26 days', NOW() - INTERVAL '25 days', 'casual', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '3 days', NOW() - INTERVAL '2 days', NOW() - INTERVAL '1 days', 'casual', 'CSE', NOW(), NOW()),
-- Older than 1 month
('123', NOW() - INTERVAL '35 days', NOW() - INTERVAL '34 days', NOW() - INTERVAL '33 days', 'casual', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '41 days', NOW() - INTERVAL '40 days', NOW() - INTERVAL '39 days', 'medical', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '46 days', NOW() - INTERVAL '45 days', NOW() - INTERVAL '43 days', 'casual', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '52 days', NOW() - INTERVAL '51 days', NOW() - INTERVAL '49 days', 'specialCasual', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '56 days', NOW() - INTERVAL '55 days', NOW() - INTERVAL '54 days', 'casual', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '61 days', NOW() - INTERVAL '60 days', NOW() - INTERVAL '58 days', 'medical', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '66 days', NOW() - INTERVAL '65 days', NOW() - INTERVAL '63 days', 'casual', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '72 days', NOW() - INTERVAL '71 days', NOW() - INTERVAL '70 days', 'casual', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '85 days', NOW() - INTERVAL '84 days', NOW() - INTERVAL '83 days', 'specialCasual', 'CSE', NOW(), NOW()),
('123', NOW() - INTERVAL '95 days', NOW() - INTERVAL '94 days', NOW() - INTERVAL '93 days', 'casual', 'CSE', NOW(), NOW());
...
select * from public."LeaveApproved";
